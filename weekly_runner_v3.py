...
GEE_SERVICE_ACCOUNT = os.getenv("GEE_SERVICE_ACCOUNT", "gee-dashboard-runner@babakdialameh-92.iam.gserviceaccount.com")
...
def initialize_earth_engine() -> bool:
    ...
    try:
        if GEE_SERVICE_ACCOUNT_KEY_JSON:
            ...
            service_account = GEE_SERVICE_ACCOUNT or key_data.get("client_email")
